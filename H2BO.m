...
[labels_homog1, labels_heter1, sppx_median1, sppx_dist1, sppx_dist_avg1, sppx_dist_avg_trim1, sppx_dist_max1, sppx_dist_max_trim1, sppx_dist_ratio1] = homog_median_dist(data, spSegs, labels, tau_homog, tau_outliers,'F','F');
if ~isempty(labels_heter1)
    ...
    [labels_homog2, labels_heter2, sppx_median2, sppx_dist2, sppx_dist_avg2, sppx_dist_avg_trim2, sppx_dist_max2, sppx_dist_max_trim2, sppx_dist_ratio2] = homog_median_dist(data, spSegs, labels2, tau_homog, tau_outliers,'F','F');
end
...
if ~isempty(labels_heter2)
    ...
    [labels_homog3, labels_heter3, sppx_median3, sppx_dist3, sppx_dist_avg3, sppx_dist_avg_trim3, sppx_dist_max3, sppx_dist_max_trim3, sppx_dist_ratio3] = homog_median_dist(data, spSegs, labels3, tau_homog, tau_outliers,'F','F');  
end
...
if ~isempty(labels_heter3)
    ...
    [labels_homog4, labels_heter4, sppx_median4, sppx_dist4, sppx_dist_avg4, sppx_dist_avg_trim4, sppx_dist_max4, sppx_dist_max_trim4, sppx_dist_ratio4] = homog_median_dist(data, spSegs, labels4, tau_homog, tau_outliers,'F','F');
end
